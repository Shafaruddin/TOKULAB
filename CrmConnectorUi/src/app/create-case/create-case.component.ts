...
export class CreateCaseComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      AppConsts.ciscoParameters.agentUsername = params.agentUsername || "";
      AppConsts.ciscoParameters.agentName = params.agentName || "";
      AppConsts.ciscoParameters.iPCCCallExtensionID = params.iPCCCallExtensionID || "";
